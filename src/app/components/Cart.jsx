  ...
  return (
    ...
    <div className="absolute top-4 mb-4 left-4 bg-brand-primary text-brand-secondary p-1 rounded-full">
      <ChevronLeft />
                ...
                <h2 className='lg:text-xl text-lg mb-4 mx-10 font-bold text-brand-secondary'>Items From Your Cart</h2>
            </div>
...
<div className='flex items-center justify-center '>
    <h2 className='lg:text-xl text-lg text-center text-brand-secondary font-bold'>You haven’t added any items in bucket yet</h2>
</div>
...
<div className='bg-brand-darkGray p-4 rounded-lg lg:w-[400px] w-[320px]'>
    <h1 className='text-xl text-brand-secondary font-bold  border-b-2 border-brand-primary'>0 Items Added</h1>
<div className='mt-3 flex flex-col bg-brand-accent rounded-lg mx-1 p-2'>
    <h3 className='text-brand-secondary lg:text-lg text-md mx-2'>Special Instructions (Optional)</h3>
    <div className=" rounded-lg">
    <textarea  name="" id="" placeholder='Additional instructions' className="text-brand-secondary bg-brand-darkGray w-full p-2 rounded-lg mt-2 focus:outline-none focus:ring-2 focus:ring-brand-primary"
    ></textarea>
...
<div className='mt-3 flex flex-col bg-brand-accent rounded-lg mx-1 p-2'>
    <h2 className='lg:text-3xl text-2xl text-center text-brand-secondary font-bold'>Your Order</h2>
...
<div className='flex flex-col items-center mt-5  justify-center mx-auto'>
    <button className='bg-brand-primary w-full lg:py-3 py-2 rounded-lg text-xl text-brand-secondary font-bold '>Checkout</button>
</div>
</div>
        </div>
    </div>

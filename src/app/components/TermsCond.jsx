...
const TermsCond = () => {
  return (
    <div className="flex lg:w-[85vw] w-[95vw] flex-col mx-auto my-5 leading-6 tracking-wide">
      <h1 className="text-brand-secondary text-center lg:text-3xl text-2xl font-bold">
        Terms and Conditions
      </h1>
      <h3 className="font-extralight my-6 text-center text-brand-secondary">
        KFC TERMS OF USE
      </h3>
      <p className="text-brand-secondary">
        These Terms of Use ("Terms") govern your use the KFC Corporation ("KFC")
        Web sites on which they appear, and your use of the features therein.
        KFC may revise the information, services and the resources contained in
        this web site from time to time and we reserve the right to make such
        changes without obligation to notify past, current or prospective
        visitors.
      </p>
      <div>
        <h3 className="lg:text-xl text-lg text-brand-secondary mt-5 font-bold">
          NO WARRANTY/LIMITATION ON LIABILITY
        </h3>
        <p className="text-brand-secondary">
          KFC strives to ensure that the information contained in this web site
          is accurate and reliable. However, KFC and the World Wide Web (or Web
          Site Host) are not infallible and errors may sometimes occur.
          Therefore, to the fullest extent permissible pursuant to applicable
          law, KFC makes no representations about the reliability of the
          features of this Site, the KFC Content (defined below), Submitted
          Content (defined below), or any other Site feature. You acknowledge
          that any reliance on such material and/or systems will be at your own
          risk. KFC is not responsible for the information, data, text or other
          materials that may appear in Submitted Content or may otherwise be
          submitted by users. Opinions expressed in Submitted Content do not
          necessarily reflect the opinions of KFC, and KFC does not endorse and
          has no control over Submitted Content. Submitted Content is not
          necessarily reviewed by KFC prior to posting and KFC makes no
          warranties, express or implied, as to the Submitted Content or to the
          accuracy and reliability of the Submitted Content. KFC makes no
          representations regarding the amount of time that any KFC Content or
          Submitted Content will be preserved.
        </p>
        <p className="text-brand-secondary mt-2">
          KFC disclaims any warranty of any kind, whether express or implied, as
          to any matter whatsoever relating to this web site, including without
          limitation the merchantability or fitness for any particular purpose.
          KFC is not liable or responsible for any damages or injuries caused by
          use of this web site (such as viruses , omissions or misstatements).
          ...
          RESPECT TO THIS SITE OR ANY INFORMATION OR SOFTWARE THEREIN. UNDER NO
          CIRCUMSTANCES, INCLUDING NEGLIGENCE, SHALL KFC BE LIABLE FOR ANY
          DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL
          DAMAGES THAT RESULT FROM THE USE OF OR INABILITY TO USE THIS SITE, NOR
          SHALL KFC BE RESPONSIBLE FOR ANY DAMAGES WHATSOEVER THAT RESULT FROM
          MISTAKES, OMISSIONS, INTERRUPTIONS, DELETION OF FILES, ERRORS,
          DEFECTS, DELAYS IN OPERATION OR TRANSMISSION, OR ANY FAILURE OF
          PERFORMANCE WHETHER OR NOT CAUSED BY EVENTS BEYOND KFC' S REASONABLE
          CONTROL, INCLUDING BUT NOT LIMITED TO ACTS OF GOD, COMMUNICATIONS LINE
          FAILURE, THEFT, DESTRUCTION, OR UNAUTHORIZED ACCESS TO THIS SITE' S
          RECORDS, PROGRAMS, OR SERVICES. In no event shall KFC' s total
          liability for all damages, losses, and causes of action exceed five
          dollars (US $5.00). Some jurisdictions do not allow the limitation or
          exclusion of liability for incidental or consequential damages; as a
          result, the above limitation or exclusion may not apply to you.
        </p>
        <div>
          <h3 className="lg:text-xl text-lg text-brand-secondary mt-5 font-bold">
        ...
        <div>
          ...
          <ul className="list-disc pl-6">
            <li className="text-brand-secondary mt-2 text-lg">
            ...
            <li className="text-brand-secondary mt-2 text-xl">

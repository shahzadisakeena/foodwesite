...
const factsData = [
  {
    image: '/images/pk.png',
    year: '1997',
    description: 'The first KFC restaurant in Pakistan opened in 1997 and was located in Gulshan-e-Iqbal Karachi.',
  },
  {
      ...
      <div className="flex items-center justify-between mt-10 w-[90vw] mx-auto gap-4">
        {factsData.map((fact, index) => (
          <div key={index} className="flex flex-col items-center justify-center">
            ...
            />
            <h3 className="text-4xl text-center text-brand-secondary font-bold mt-5">{fact.year}</h3>
            <p className="text-xs text-brand-secondary px-6 text-center mt-2 leading-5 mb-10">{fact.description}</p>
          </div>
        ))}
      </div>
    </div>

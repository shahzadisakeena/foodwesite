...
const FeedBack = () => {
  ...
  return (
    <div className=' lg:mt-28 mt-32'>
        <h3 className='text-brand-secondary text-center lg:text-3xl text-2xl font-bold'>Have Some Feedback To Share?</h3>
        <h3 className='text-brand-primary text-center lg:text-2xl text-xl my-2'>Well, you’ve come to the right place!</h3>
    <p className='text-brand-secondary text-lg lg:w-[60%]  lg:mx-auto   text-center'>Fill in the sections below and we'll be in touch soon, or if you want to contact a specific store, visit our locations page for store contact details. * indicates a required answer</p>
  ...
  <div className="bg-brand-darkGray p-4 w-[95vw] lg:w-[48%] rounded-xl">
    <h2 className="lg:text-2xl text-xl text-brand-secondary font-bold">Contact Details</h2>
  ...
  <input
    ...
    className={`bg-brand-lgInp mb-4 h-14 w-full rounded-t-xl border-b-2 ${
      errors.firstName ? "border-brand-primary focus:border-brand-primary" : "border-brand-secondary focus:border-brand-primary"
...
<div className="relative lg:w-64 w-full">
  ...
  {errors.phoneNumber && (
    <p className="text-brand-primary text-sm ">
      ...
      <label
    className="flex absolute left-2  text-brand-secondary text-md "
  >
    EMAIL
  </label>
  <input
    ...
    placeholder=" "
    className={` bg-brand-lgInp mb-4 h-14 w-full rounded-t-xl border-b-2 ${
      errors.email ? "border-brand-primary focus:border-brand-primary" : "border-brand-secondary focus:border-brand-primary"
...
<div className="flex flex-col relative w-full text-brand-secondary">
  <input
    ...
    placeholder=" "
    className={`bg-brand-lgInp mb-4 h-14 w-full rounded-t-xl border-b-2 ${
      errors.orderid ? "border-brand-primary focus:border-brand-primary" : "border-brand-secondary focus:border-brand-primary"
...
<div className="relative w-full text-brand-secondary">
  <select
    ...
    className={`bg-brand-lgInp h-14 w-full rounded-t-xl border-b-2 ${
      errors.feedbackChannel ? "border-brand-primary focus:border-brand-primary" : "border-brand-secondary focus:border-brand-primary"
  ...
  >
    <option value="" disabled hidden></option> {/* Hidden initial option */}
  ...
  <div className="bg-brand-darkGray p-4  lg:w-[48%] w-[95vw] mt-8 lg:mt-0 rounded-xl">
    <h2 className="lg:text-2xl text-xl mb-4 lg:mb-0 text-brand-secondary font-bold">About Your Visit</h2>
    <form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
  ...
  <select
    ...
    className={`bg-brand-lgInp h-14 lg:w-64 w-full rounded-t-xl border-b-2 ${
      errors.store ? "border-brand-primary focus:border-brand-primary" : "border-brand-secondary focus:border-brand-primary"
    } focus:outline-none px-2 pt-6 text-md`}
...
<div className="relative mt-4  lg:w-64 w-full">
  ...
  <select
    id="feedbacktype"
    className={`bg-brand-lgInp h-14 w-full rounded-t-xl border-b-2 ${
      errors.feedbacktype ? "border-red-500 focus:border-red-500" : "border-brand-secondary focus:border-brand-primary"
    } focus:outline-none px-2 pt-6 text-md`}
...
<div>
  <textarea name="" id="" className='h-28 bg-brand-lgInp rounded-xl focus:outline-brand-primary outline-none px-2 text-brand-secondary w-full mt-4'></textarea>
</div>
    </form>

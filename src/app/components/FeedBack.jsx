...
const FeedBack = () => {
  ...
  return (
    <section className="mt-10 py-20">
      {/* ===== HEADER ===== */}
      <div className="text-center w-[90vw] mx-auto mb-12">
        <h1 className="text-3xl lg:text-5xl font-extrabold text-stone-deep">
          Have Some Feedback To Share?
        </h1>

        <p className="text-stone-red text-xl mt-3 font-semibold">
          Well, you’ve come to the right place!
        </p>

        <p className="text-stone-deep/70 max-w-3xl mx-auto mt-4">
          Fill in the sections below and we’ll be in touch soon. * indicates a
          required answer.
        </p>
      </div>
      ...
      <form
        ...
        className="w-[92vw] lg:w-[85vw] mx-auto grid lg:grid-cols-2 gap-8"
      >
        {/* ================= CONTACT DETAILS ================= */}
        <div className="stone-card">
          ...
          <SelectField
            ...
            error={errors.feedbackChannel}
            register={register("feedbackChannel", {
              required: "Required",
            })}
            options={[
              "Dine In",
        ...
        {/* ================= VISIT DETAILS ================= */}
        <div className="stone-card">
          <h2 className="form-title">About Your Visit</h2>

          <SelectField
            label="Select Store"
            error={errors.store}
            register={register("store", { required: "Select store" })}
          ...
          <div className="relative mt-6">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button type="button" className="stone-input text-left">
                  {selectedDate
                    ? format(selectedDate, "dd MMM yyyy")
                    : "Select Date"}
                  <CalendarIcon className="absolute right-4 top-4 text-stone-red" />
                </button>
              </PopoverTrigger>
      ...
      <div className="flex justify-center mt-10">
        <button
          ...
          className="bg-stone-red hover:bg-stone-orange text-white px-10 py-4 rounded-xl font-semibold shadow-lg transition"
        >
          Submit Feedback
        </button>
      </div>
...
const InputField = ({ label, register, error }) => (
  <div className="relative mt-6">
    ...
    <input {...register} className="stone-input" />
...
const SelectField = ({ label, register, options, error }) => (
  <div className="relative mt-6">
    <label className="form-label">{label}</label>
    <select {...register} defaultValue="" className="stone-input">
      <option value="" disabled hidden></option>
      {options.map((opt, i) => (

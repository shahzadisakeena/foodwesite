    ...
    <main className=" py-14 lg:py-24">
      ...
      <div className="text-center mb-14">
        <h1 className="text-4xl md:text-5xl font-extrabold text-stone-deep">
          Join The StoneBake Team
        </h1>
        <p className="text-stone-deep/70 mt-3">
          Build your future with passion & flavor 🍕
        </p>
      </div>

      <div className="container w-[92vw] mx-auto flex flex-col items-center">
        <ThemeProvider theme={theme}>
          {/* ================= PERSONAL INFO ================= */}
          <Section title="Personnel Info" icon={<RiUser3Fill />}>
            <FormGrid>
              <TextField
                label="Full Name"
                variant="filled"
          ...
          {/* ================= AGREEMENT ================= */}
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-lg p-8 mt-10 text-center">
            <h2 className="text-2xl font-bold text-stone-deep mb-6">
              Applicant Agreement
            </h2>
            ...
            <button
              ...
              onClick={stdfu}
              className={`
                mt-8 px-10 py-3 rounded-xl font-semibold transition
                ${
                  !Values
                    ? "bg-stone-border text-gray-400 cursor-not-allowed"
                    : "bg-stone-red hover:bg-stone-orange text-white shadow-lg hover:scale-105"
                }
              `}
            >
              Apply Now
...
const Section = ({ title, icon, children }) => (
  <div className="w-full max-w-4xl bg-white/70 backdrop-blur-xl border border-stone-border rounded-3xl shadow-lg p-6 md:p-8 my-8">
    <h2 className="text-2xl font-bold text-stone-deep flex items-center gap-2 mb-6">
      {icon} {title}
    </h2>
    {children}
  </div>

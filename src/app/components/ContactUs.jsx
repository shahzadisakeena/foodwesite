import { LetterText, Locate, Mail, Map, MapPin, Phone, Pointer, Text } from 'lucide-react'
import React from 'react'

const ContactUs = () => {
  return (
    <div  className='flex lg:w-[85vw] w-[95vw] flex-col mx-auto my-5'>
<h1 className='text-brand-secondary text-center lg:text-3xl text-2xl font-bold'>Contact Us</h1>
...
<p className=' text-xl text-brand-secondary mt-2'>0213-5877976
</p>
<div className='flex items-center mt-5'>
        ...
        <p className=' text-lg text-brand-secondary mt-2'>Ocean Tower, 20th Floor, G-3, Block -9, Scheme 5, Main Clifton Road, Karachi, Pakistan</p>
    </div>
...
Regional Office Lahore</h3>
        </div>
<p className=' text-xl text-brand-secondary mt-2'>042-35884570
...
<div className='flex items-center mt-5'>
        ...
        <p className=' text-lg mt-2 text-brand-secondary'>27-A Ali Block New Garden Town Opposite Barkat Market Lahore</p>
    </div>
...
Regional Office Islamabad</h3>
        </div>
<p className=' text-xl text-brand-secondary  mt-2'>0512726877
...
<div className='flex items-center mt-5'>
        ...
        <p className=' text-lg mt-2 text-brand-secondary'>United Bakery Building, 11، School Rd, F-6 Markaz F-6, Islamabad, Islamabad Capital Territory 44000</p>
    </div>
</div>
...
<div className='flex items-center'>
        ...
        <p className='text-lg text-brand-secondary'>customercare@kfcpakistan.com</p>
</div>
</div>
    </div>
  )

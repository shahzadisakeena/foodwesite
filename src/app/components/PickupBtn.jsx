...
const PickupBtn = () => {
  ...
  const [locationSelect, setLocationSelect] = useState({ isTrue: false, value: "" });
          ...
          <div className="mt-4 mb-4 overflow-y-scroll">
            <div className="flex flex-col justify-center">
              {addresses.map((add, index) => (
                <div key={index} onClick={() => setLocationSelect({ isTrue: true, value: add.location })} tabIndex={0} className="pb-3 px-1 border-b-2 cursor-pointer focus:bg-brand-primary transition-colors duration-300 focus:!text-white group">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="flex items-center space-x-2">
                      <h6 className="mb-0 text-base font-medium">Distance to store:</h6>
                      <h6 className="mb-0 text-base font-medium">{add.distance}</h6>
                    </span>
                    <button
                      ...
                      type="button">
                      <h6 className="mb-0 text-sm font-medium mr-2">Get Direction</h6>

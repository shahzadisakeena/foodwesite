  ...
  return (
    ...
    <div className="absolute top-4 mb-4 left-4 bg-brand-primary text-brand-secondary p-1 rounded-full">
      <ChevronLeft />
                ...
                <h2 className='text-xl mb-4 mx-10 font-bold text-brand-secondary'>Items From Your Cart</h2>
            </div>
...
<div className='flex items-center justify-center -mt-10'>
    <h2 className='text-xl text-brand-secondary font-bold'>You haven’t added any items in bucket yet</h2>
</div>
